...
#define LS                     0.000800 /* Stator inductance, H
...
#define NOMINAL_CURRENT         7864
#define MOTOR_MAX_SPEED_RPM     3000 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  6.6 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -7864 /*!< Demagnetization current */
